module.exports = {
    apps: [
        {
            name: "sfims",
            script: "/home/gssiot/바탕화면/cjs/sfims/main.js",
    ...
    deploy: {
        development: {
            // 개발 환경설정
            user: "gssiot",
            host: [{ host: "192.168.0.2", port: "22" }],
            ref: "origin/master", // 리모트 브랜치
            repo: "git@github.com:lalalalz/sfims.git", // Github 프로젝트 주소
            path: "/home/gssiot/바탕화면/cjs/sfims2", // 원격 서버에서 프로젝트를 생성할 위치
            // 프로젝트 배포 후 실행할 명령어
            "post-deploy":
