...
SELECT 
    FARM_ID,
    DATE,
    ROUND(AVG(TEMP),2)       AS MIN_TEMP,
    ROUND(AVG(HUMID),2)      AS MIN_HUMID,
    ROUND(AVG(DEWPOINT),2)   AS MIN_DEWPOINT,
    ROUND(AVG(FLOW),2)       AS MIN_FLOW,
    ROUND(AVG(RAIN_GAUGE),2) AS MIN_RAIN_GAUGE,
    ROUND(AVG(ACTINO),2)     AS MIN_ACTINO,
    ROUND(AVG(WINDDIR),2)    AS MIN_WINDDIR,
    ROUND(AVG(WINDSPEED),2)  AS MIN_WINDSPEED,
    ROUND(AVG(VOLTAGE),2)    AS MIN_VOLTAGE,
    ROUND(AVG(CO2),2)        AS MIN_CO2,
    ROUND(AVG(EC),2)         AS MIN_EC,
    ROUND(AVG(SOIL_HUM),2)   AS MIN_SOIL_HUM,
    ROUND(AVG(SOIL_TENS),2)  AS MIN_SOIL_TENS,
    ROUND(AVG(PH),2)         AS MIN_PH,
    ROUND(AVG(SOIL_TEMP),2)  AS MIN_SOIL_TEMP,
    ROUND(AVG(WEIGHT),2)     AS MIN_WEIGHT,
    ROUND(AVG(SMOKE),2)      AS MIN_SMOKE,
    ROUND(AVG(GAS),2)        AS MIN_GAS,
    ROUND(AVG(BRIGHT),2)     AS MIN_BRIGHT,
    ROUND(AVG(E_CURRENT),2)  AS MIN_E_CURRENT
    ROUND(AVG(TEMP),2)       AS MAX_TEMP,
    ROUND(AVG(HUMID),2)      AS MAX_HUMID,
    ROUND(AVG(DEWPOINT),2)   AS MAX_DEWPOINT,
    ROUND(AVG(FLOW),2)       AS MAX_FLOW,
    ROUND(AVG(RAIN_GAUGE),2) AS MAX_RAIN_GAUGE,
    ROUND(AVG(ACTINO),2)     AS MAX_ACTINO,
    ROUND(AVG(WINDDIR),2)    AS MAX_WINDDIR,
    ROUND(AVG(WINDSPEED),2)  AS MAX_WINDSPEED,
    ROUND(AVG(VOLTAGE),2)    AS MAX_VOLTAGE,
    ROUND(AVG(CO2),2)        AS MAX_CO2,
    ROUND(AVG(EC),2)         AS MAX_EC,
    ROUND(AVG(SOIL_HUM),2)   AS MAX_SOIL_HUM,
    ROUND(AVG(SOIL_TENS),2)  AS MAX_SOIL_TENS,
    ROUND(AVG(PH),2)         AS MAX_PH,
    ROUND(AVG(SOIL_TEMP),2)  AS MAX_SOIL_TEMP,
    ROUND(AVG(WEIGHT),2)     AS MAX_WEIGHT,
    ROUND(AVG(SMOKE),2)      AS MAX_SMOKE,
    ROUND(AVG(GAS),2)        AS MAX_GAS,
    ROUND(AVG(BRIGHT),2)     AS MAX_BRIGHT,
    ROUND(AVG(E_CURRENT),2)  AS MAX_E_CURRENT
